...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // En /login no mostramos el chrome de la app (header/nav/footer).
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav aria-label="Navegación principal" className="flex items-center gap-1">
              <Link href="/" style={navLink} className="hover:text-cream hover:bg-white/10">
                Proyectos
              </Link>
              <Link href="/reporte" style={navLink} className="hover:text-cream hover:bg-white/10">
                Sesión
              </Link>
              <Link href="/reporte/mensual" style={navLink} className="hover:text-cream hover:bg-white/10">
                Mensual
              </Link>
              <Link href="/reporte/general" style={navLink} className="hover:text-cream hover:bg-white/10">
                General
              </Link>
              <Link
                href="/papelera"
              ...
              <button
                ...
                style={{ ...navLink, background: "transparent", border: "none", cursor: "pointer" }}
                className="hover:text-cream hover:bg-white/10"
              >
                Salir
              </button>
